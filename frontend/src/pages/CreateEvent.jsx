    ...
    return (
      <div className="max-w-[1050px] mx-auto px-6 pt-12 pb-20">
        <div className="max-w-[540px] mx-auto mt-16 bg-white/[0.02] border border-white/[0.06] rounded-[20px] p-12 text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-50 m-0 mb-2">Event Created!</h2>
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button id="view-map-btn" onClick={() => onNavigate('map-viewer', createdEvent._id)} className="btn-gradient text-white border-none px-7 py-3 text-base font-semibold rounded-lg cursor-pointer font-[inherit] transition-all duration-200">View Floor Map</button>
            <button id="all-events-btn" onClick={() => onNavigate('events')} className="bg-white/[0.03] text-slate-50 border border-white/10 px-7 py-3 text-base font-semibold rounded-lg cursor-pointer font-[inherit] hover:bg-white/[0.08] hover:border-white/20 transition-all duration-200">All Events</button>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="max-w-[1050px] mx-auto px-6 pt-12 pb-20">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-extrabold gradient-text-hero m-0 mb-4">Create Event</h1>
        <p className="text-slate-500 text-base m-0 leading-relaxed">Add a new event with a banner and floor map to EventPulse.</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-10 items-start max-[768px]:grid-cols-1">
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <button type="button" onClick={() => onNavigate('events')} className="bg-white/[0.03] text-slate-50 border border-white/10 w-full py-4 text-base font-semibold rounded-lg cursor-pointer font-[inherit] hover:bg-white/[0.08] hover:border-white/20 transition-all duration-200">
            Cancel
          </button>
        </form>
      </div>
