...
export default function App() {
  ...
  return (
    <Routes>
      ...
      {/* ── Landing Page — teammate's work, not touched ── */}
      <Route path="/" element={
        <div className="landing-container">
          ...
          <header className="navbar">
            ...
            <nav className="nav-links">
              ...
              <button onClick={openDemoModal} className="btn-secondary">Request Demo</button>
            </nav>
          </header>
      ...
      {/* ── EP-33: Profile Update Form — your work ── */}
      <Route path="/business/profile" element={<ProfileUpdateForm />} />
